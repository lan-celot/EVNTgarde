...
const VendorRegistrationDark: React.FC = () => {
...
/>
            ...
            <div>
            <label className="block text-sm font-medium text-white">Company Phone Number</label>
...
/>
            ...
            <div>
            <label className="block text-sm font-medium text-white">Company E-mail Address</label>
            <input
                type="email"
            ...
            <select
                className="w-full px-1 py-1 border border-gray-300 rounded-md bg-gray-700 text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={selected}
            ...
            <label className="block text-sm font-medium text-white">System Preferences</label>
            ...
            <button type="submit" className="bg-blue-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700 text-base w-full max-w-md">
                Create Account
            </button>
            </div>
...
export default VendorRegistrationDark;