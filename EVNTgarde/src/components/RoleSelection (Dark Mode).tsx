        ...
        <div className="flex h-screen items-center justify-center bg-gray-300 font-[Poppins]">
            ...
            <div className="w-3/5 bg-gray-800 p-10 flex flex-col justify-center text-center rounded-l-[50px] shadow-md">
                <h2 className="text-4xl font-bold text-white mb-8">Select your role</h2>
                    ...
                    <button type = "submit" className = "bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 w-52 shadow-md transition">Individual</button>
                    <button type = "submit" className = "bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 w-52 shadow-md transition">Organizer</button>
                    <button type = "submit" className = "bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 w-52 shadow-md transition">Vendor</button>
                </form>
            </div>
        </div>
    </div>
