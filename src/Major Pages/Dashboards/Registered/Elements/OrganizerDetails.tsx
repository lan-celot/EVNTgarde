  ...
  if (!organizer) {
   ...
   return (
    <div className="flex flex-1 flex-col transition-all duration-300 md:ml-64">
      {/* Main Content */}
      <div className="w-full max-w-7xl mx-auto dark:bg-gray-900 py-4 px-4 sm:px-6 overflow-hidden">
        <button 
  onClick={() => navigate('/dashboard', { state: { activeTab: 'explore' } })}
  className="flex items-center text-gray-600 dark:text-gray-300 hover:text-[#2B579A] dark:hover:text-blue-400 mb-4 transition-colors"
>
  ...
  Back
        ...
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-xl sm:text-2xl font-bold text-dark dark:text-white">{organizer.name}</h1>
  ...
  <nav className="flex items-end space-x-8 px-4 sm:px-6">
    <button
      ...
      className={`py-4 px-1 text-center border-b-2 font-medium text-sm sm:text-base ${
        activeTab === 'about'
          ? 'border-[#2B579A] text-[#2B579A] dark:text-blue-400 dark:border-blue-400'
      ...
      <span className="ml-2 inline-flex items-center">
        ...
        <div className="px-4 sm:px-6 py-4">
          {activeTab === 'about' ? (
            <>
              <div className="mb-8">
                <p className="text-dark-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base mb-6">
                ...
                <div className="mb-8">
                  <div className="flex flex-col lg:flex-row gap-10">
                    <div className="w-full lg:w-1/2">
                      ...
                      <div className="mb-6">
                        <h3 className="text-base sm:text-lg font-semibold text-dark-800 dark:text-gray-200 mb-2">
                          Contact Details
                        </h3>
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center">
                            <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-gray-600 dark:text-gray-400 mr-2" />
                            <a
                              href={`tel:${organizer.phone}`}
                              className="text-dark-600 dark:text-gray-400 text-sm sm:text-base hover:text-[#2B579A] dark:hover:text-blue-400 transition-colors"
                            >
                              {organizer.phone}
                            </a>
                          </div>
                          <div className="flex items-center">
                            <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-gray-600 dark:text-gray-400 mr-2" />
                            <a
        ...
        <div className="mb-8">
  <h3 className="text-base sm:text-lg font-semibold text-dark-800 dark:text-gray-200 mb-2">Location</h3>
  <div className="flex flex-col gap-4">
    <div className="w-full">
      <p className="text-dark-600 dark:text-gray-400 text-sm sm:text-base">{organizer.location}</p>
      <p className="mt-2 text-dark-700 dark:text-gray-300 text-sm sm:text-base">
        Find the best route to your event location with ease.
      </p>
    </div>
    <div className="w-full lg:w-1/2"> {/* Changed to half width on large screens */}
      <div className="h-48 sm:h-64 bg-gray-300 dark:bg-gray-700 flex items-center justify-center text-gray-500 rounded-lg">
        Map Goes Here 🗺️
      </div>
    </div>
  </div>
            ...
            <div className="w-full lg:w-2/5">
                      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
                        ...
                        <p className="text-dark-600 dark:text-gray-400 text-sm text-left mb-6">
                        ...
                        <div className="space-y-3">
                          <button
                            ...
                            className="w-full flex items-center justify-between bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3 hover:border-[#2B579A] dark:hover:border-blue-400 transition-colors"
                          >
                            <div>
                              <h4 className="font-medium text-dark-800 dark:text-gray-200">Per Person Rate</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">starts at Php 500</p>
                            </div>
                          ...
                          >
                            <div>
                              <h4 className="font-medium text-dark-800 dark:text-gray-20 text-left">Package Deal</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">starts at Php 99,999</p>
                            </div>
                            <ChevronRight className="h-5 w-5 text-gray-400" />
                          </button>
                          ...
                          >
                            <div>
                              <h4 className="font-medium text-dark-800 dark:text-gray-200 text-left">Hourly Rate</h4>
                              <p className="text-sm text-gray-500 dark:text-gray-400">starts at Php 10,000</p>
                            </div>
                            <ChevronRight className="h-5 w-5 text-gray-400" />
                          </button>
                        </div>
            ...
            <>
              <div className="space-y-6">
                {currentReviews.map((review, index) => (
                  <div key={index} className="w-full dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-md">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                      <h3 className="text-base sm:text-lg font-semibold text-dark dark:text-gray-200">
                    ...
                    <div className="flex items-center mt-2">
                    {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`h-4 w-4 sm:h-5 sm:w-5 ${i < review.rating ? "text-yellow-400" : "text-gray-300"}`} />
                      ))}
                    </div>
                    <p className="mt-3 sm:mt-4 text-dark dark:text-gray-300 leading-relaxed text-sm sm:text-base">
                      {review.comment}
                    </p>
                    <div className="mt-3 sm:mt-4 text-xs sm:text-sm font-medium text-dark dark:text-gray-400">
      ...
      {/* Footer */}
      <footer className="bg-[#2B579A] text-white dark:bg-[rgb(30,58,109)] py-6 sm:py-8">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/3 mb-6 md:mb-0 pr-0 md:pr-8">
              <img
                ...
                alt="Logo"
                className="h-20 sm:h-24 w-auto mb-3 sm:mb-4 cursor-pointer"
                onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
              />
              <span className="text-xs sm:text-sm font-bold tracking-wide text-gray-200 block">
                Your next successful event starts here
              </span>
            </div>
            <div className="w-full md:w-2/3 flex flex-wrap">
              <div className="w-1/2 sm:w-1/3 mb-4 pr-2 sm:pr-4">
                <h4 className="font-semibold mb-2 sm:mb-4 text-sm sm:text-base">Company Info</h4>
              ...
              <div className="w-1/2 sm:w-1/3 mb-4 pr-2 sm:pr-4">
                <h4 className="font-semibold mb-2 sm:mb-4 text-sm sm:text-base">Categories</h4>
                <ul className="space-y-1 sm:space-y-2">
                  <li>
                    <a href="#" className="hover:underline text-xs sm:text-sm">
                      Concerts & Gigs
              ...
              <div className="w-1/2 sm:w-1/3 mb-4">
                <h4 className="font-semibold mb-2 sm:mb-4 text-sm sm:text-base">Follow Us</h4>
                <ul className="space-y-1 sm:space-y-2">
                  <li>
                    <a href="#" className="hover:underline text-xs sm:text-sm">
                      Facebook
          ...
          <div className="mt-6 sm:mt-8 border-t border-blue-500 pt-4 sm:pt-6 text-center text-xs sm:text-sm">
      ...
      {isRateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl pointer-events-auto">
                ...
                <div>
                  ...
                  <div className="space-y-3 mt-4">
                    <button
                      ...
                      className="w-full flex items-center justify-between bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-[#2B579A] dark:hover:border-blue-400 transition-colors"
                    >
                      <h4 className="font-medium text-dark-800 dark:text-gray-200">Package Deal</h4>
                      <ChevronRight className="h-5 w-5 text-gray-400" />
                    </button>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-[#2B579A] dark:hover:border-blue-400 transition-colors"
                    >
                      <h4 className="font-medium text-dark-800 dark:text-gray-200">Hourly Rate</h4>
                      <ChevronRight className="h-5 w-5 text-gray-400" />
                    </button>
                  </div>
                </div>
