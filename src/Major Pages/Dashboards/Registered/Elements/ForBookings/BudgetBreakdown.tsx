const BudgetBreakdown: React.FC = () => {
  return (
    <div className="w-60 p-5 ml-45 bg-white rounded-md shadow-md">
      ...
      <div className="mb-2 h-5 rounded text-lg font-semibold text-gray-900">
        Budget Breakdown
      </div>
      {/* Total Expenses (Title + Value in a gray background) */}
      <div className="mb-2 p-2 bg-gray-100 rounded">
        <div className="text-md font-medium text-gray-900">Total Expenses</div>
        <div className="text-md font-medium text-red-800">Php 4,500</div>
      </div>
      {/* Budget Items */}
      <div className="mb-1 h-5 rounded text-sm text-gray-900">
