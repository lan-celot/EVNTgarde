...
const allEvents = [
  {
    ...
    fullDetails:
      "Our standard package covers the essentials for a memorable event without breaking the budget.",
    included: [
      {
  ...
  },
  {
    ...
    fullDetails:
      "The luxury package includes premium services to make your event stand out with elegance.",
    included: [
      {
  ...
  },
  {
    ...
    fullDetails:
      "Ideal for clients who want to maximize their event while staying within budget.",
    included: [
      {
  ...
  },
  {
    ...
    fullDetails:
      "This covers everything needed for your event to succeed smoothly.",
    included: [
      {
        section: "Standard Features",
        bullets: ["Buffet catering", "Basic stage setup", "Free consultation"],
      },
    ],
  },
  {
    ...
    fullDetails:
      "More exclusive venues and premium suppliers to suit your luxurious needs.",
    included: [
      {
  ...
  },
  {
    ...
    fullDetails:
      "Providing more flexible options for different client needs without sacrificing quality.",
    included: [
      {
        section: "Features",
        bullets: [
