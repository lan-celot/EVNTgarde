...
export default function Packages({ logout }: PackagesProps) {
          ...
          <div className="container px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {packages.map((pkg, index) => (
                <Card
                  key={index}
                  className="p-6 shadow-lg hover:shadow-xl transition-all bg-white dark:bg-gray-800"
                >
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <Button className="mt-6 w-full text-gray-900">
                      Select Plan
                    </Button>
                  </CardContent>
                </Card>
