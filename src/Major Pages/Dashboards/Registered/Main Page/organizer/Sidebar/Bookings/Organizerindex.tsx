              ...
              <>
                ...
                {loading ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-gray-500">No {activeSection.toLowerCase()} found.</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {getCurrentRequests().map((request) => (
                      ...
                      >
                        ...
                        {["CICS", "Electric", "Microsoft"].some(keyword => request.title.includes(keyword)) ? (
                            <img
                        ...
                        <div className="p-4">
                          <div className="flex justify-between items-start mb-2">
                            <h3 className="text-lg text-gray-900 font-medium leading-tight">{request.title}</h3>
                            <div
                          ...
                          <p className="text-sm text-gray-600 mb-1">{request.organization}</p>
                          <p className="text-sm text-gray-500">
                            {request.dates.length > 0 && formatDate(request.dates[0].start)}
                          </p>
                        </div>
                      </div>
                    ))}
