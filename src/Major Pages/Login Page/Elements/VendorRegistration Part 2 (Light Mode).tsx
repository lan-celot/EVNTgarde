...
const VendorRegistrationPart2: React.FC = () => {
      ...
      <div className="flex w-[1440px] h-[650px] bg-blue-600 rounded-xl shadow-lg overflow-hidden font-poppins">
        ...
        <div className="w-3/5 bg-white p-10 flex flex-col justify-center rounded-l-[50px] shadow-md">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Business E-mail Address*</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Enter Password*</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Confirm Password*</label>
              <div className="relative">
                <input
...
export default VendorRegistrationPart2