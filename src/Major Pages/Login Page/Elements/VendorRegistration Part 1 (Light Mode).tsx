...
const VendorRegistrationPart1: React.FC = () => {
        ...
        <div className="w-3/5 bg-white p-12 flex flex-col justify-center rounded-l-[50px] shadow-md">
          ...
          <form className="space-y-6" onSubmit={handleProceed}>
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex text-gray-700 start-x-6 justify-start">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Vendor Name*</label>
              <input
                type="text"
            ...
            <div className="relative w-full">
              <label className="block text-sm font-medium text-gray-700 mb-4">Business Offering*</label>
              <select
                className="w-full px-4 py-2 border border-gray-300 rounded-md bg-white text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">System Preferences*</label>
...
export default VendorRegistrationPart1