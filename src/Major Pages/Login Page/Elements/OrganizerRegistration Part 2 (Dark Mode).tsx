...
const OrganizerRegistrationDarkPart2: React.FC = () => {
      ...
      <div className="flex w-[1440px] h-[650px] bg-blue-600 rounded-xl shadow-lg overflow-hidden font-poppins">
        ...
        <div className="w-3/5 bg-gray-700 p-10 flex flex-col justify-center rounded-l-[50px] shadow-md">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-sm font-medium text-white mb-2">Company E-mail Address*</label>
              <input
                type="email"
...
export default OrganizerRegistrationDarkPart2
