...
return (
    ...
    <div className="flex w-[1440px] h-[650px] bg-blue-600 rounded-xl shadow-lg overflow-hidden">
        ...
        />
            ...
            <input type="text" placeholder="Enter company phone number" className="w-full px-2 py-2 focus:outline-none" required />
            </div>
        </div>
        ...
        <div className = "flex justify-center">
            <button type = "submit" className="bg-blue-600 text-white px-10 py-5 rounded-full font-bold hover:bg-blue-700 text-lg w-full max-w-lg"> Create Account </button>
        </div>
